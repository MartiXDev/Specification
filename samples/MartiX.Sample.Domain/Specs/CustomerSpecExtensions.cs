...
// These extensions are applied in MartiX.Sample.Domain.Specs.CustomerSpec
public static class CustomerSpecExtensions
{
    ...
    // These extensions are applied in MartiX.Sample.Domain.Specs.AdultCustomersByNameSpec
