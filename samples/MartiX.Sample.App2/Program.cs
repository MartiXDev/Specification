using MartiX.Sample.Domain;
using MartiX.Sample.Domain.Specs;
...
// We have added a new feature "QueryTag" to the specification. Check the extension in MartiX.Sample.Domain.CustomerSpecExtensions.
